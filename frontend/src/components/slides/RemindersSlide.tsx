...
export function RemindersSlide() {
  ...
  return (
    <SlideShell eyebrow="SECCIÓN 05" title="Recordatorios clave"
      ...
      <div className="mt-9 border-t border-line px-5 pt-7 text-center">
        ...
        <p className="mt-1 text-sm text-ink-2">{meta?.dirigidoA ?? 'Oficina Regional de Tampa'} — Manual Operativo de Trámites de DNI</p>
